...
const FREE_PLATFORMS = [
  ...
  },
  {
    ...
    badge: 'FREE TIER',
    badgeColor: '#0ea5e9',
    desc: 'Run Llama, DeepSeek, Qwen3 & GPT-OSS on Ollama cloud GPUs. Free tier available.',
    placeholder: 'ollama_...',
    docsUrl: 'https://ollama.com/settings/keys',
    note: 'Get a free API key at ollama.com/settings/keys — free tier included, no credit card required for signup.',
    models: [
      { id: 'llama3.3:cloud',        label: 'Llama 3.3 70B',    tag: 'Recommended' },
      { id: 'llama4:cloud',          label: 'Llama 4 Scout',    tag: 'Latest' },
      { id: 'deepseek-r1:cloud',     label: 'DeepSeek R1',      tag: 'Reasoning' },
      { id: 'deepseek-v3.1:cloud',   label: 'DeepSeek V3.1',    tag: '' },
      { id: 'qwen3:cloud',           label: 'Qwen3 8B',         tag: 'Fast' },
      { id: 'qwen3:30b-cloud',       label: 'Qwen3 30B',        tag: '' },
      { id: 'gpt-oss:20b-cloud',     label: 'GPT-OSS 20B',      tag: '' },
      { id: 'gpt-oss:120b-cloud',    label: 'GPT-OSS 120B',     tag: 'Powerful' },
      { id: 'gemma3:cloud',          label: 'Gemma 3 9B',       tag: '' },
      { id: 'phi4:cloud',            label: 'Phi-4 14B',        tag: '' },
    ],
    defaultModel: 'llama3.3:cloud',
  },
];
    ...
    <div className="space-y-4">
      ...
      <div className="p-3 rounded-xl space-y-2" style={{ background: 'rgba(124,58,237,0.06)', border: '1px solid rgba(124,58,237,0.15)' }}>
        ...
        <div className="flex items-center gap-2 text-xs" style={{ color: 'var(--text-secondary)' }}>
          ...
          <span style={{ color: 'var(--text-muted)' }}>→ OpenRouter free models (no credit card) / Ollama Cloud (free API key)</span>
        </div>
        <div className="flex items-center gap-2 text-xs" style={{ color: 'var(--text-secondary)' }}>
