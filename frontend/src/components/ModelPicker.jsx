...
const PROVIDER_MODELS = {
  ...
  ollama_cloud: {
    ...
    icon: '🦙',
    models: [
      { id: 'llama3.3',       label: 'Llama 3.3 70B',   tag: 'Recommended', icon: '🦙' },
      { id: 'llama4',         label: 'Llama 4 Scout',   tag: 'Latest',      icon: '🦙' },
      { id: 'deepseek-r1',    label: 'DeepSeek R1',     tag: 'Reasoning',   icon: '🧠' },
      { id: 'deepseek-v3',    label: 'DeepSeek V3',     tag: '',            icon: '💬' },
      { id: 'qwen3',          label: 'Qwen3 8B',        tag: 'Fast',        icon: '🔮' },
      { id: 'qwen3:30b',      label: 'Qwen3 30B',       tag: '',            icon: '🔮' },
      { id: 'gemma3',         label: 'Gemma 3 9B',      tag: '',            icon: '✨' },
      { id: 'phi4',           label: 'Phi-4 14B',       tag: '',            icon: '🔬' },
      { id: 'mistral',        label: 'Mistral 7B',      tag: 'Fast',        icon: '🌬️' },
    ],
  },
  anthropic: {
    label: 'Anthropic',
